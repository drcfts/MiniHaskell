...
import br.unb.poo.mh.expressoes.matematicas.Divisao;
...
public class TesteExpressaoDivisao {
	...
	public void testeExpressaoSimples() {
		...
		Expressao m = new Divisao(v10, v5);
	...
	public void TesteExpressaoComplexa() {
		// (200/5)/10
		Expressao interna = new Divisao(v200, v5);
		Expressao complexo = new Divisao(interna, v10);
